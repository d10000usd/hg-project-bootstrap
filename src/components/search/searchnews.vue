<template>
        ...
        <div v-if="responseData1" style="display: flex; ">
            {{         responseData1.API.newsjson.company}}
        </div>
...
const resetAndUpdateSearch = () => {
    // Reset responseData1 to null or initial value (as needed)
    responseData1.value = null;

    // Call the updateSearch function to initiate the search
    updateSearch();
};
